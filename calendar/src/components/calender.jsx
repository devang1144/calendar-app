...
export default class Calendar extends Func {
            ...
            <nav className="navbar navbar-left m-0 navbar-expand-lg navbar-sticky-top">
                <div className="navbar-text">
                    ...
                    <div className="row d-flex justify-content-center">
                        ...
                        <div className="navbar-nav is-white">
                        {this.renderRadio("qwerty", "Year", "year", this.handleRadio, "1")}
                        {this.renderRadio("qwerty", "month", "month", this.handleRadio, "2", "active")}
                        {this.renderRadio("qwerty", "week", "week", this.handleRadio, "3")}     
                        </div> 
                    </div>
                        </div>
    ...
    render() {
        console.log(this.state.data.qwerty)
        ...
        return (
            <div className="container-fluid landingContainer" style={this.style}>
                <div className="row">
                ...
                <div className="col-md-4 vh-100 p-0 right">
                    <nav className="navbar m-0">
                        ...
                        <i className="fa fa-list-ul p-2" style={{fontSize:24}}></i> 
                            <Link style={{textDecoration:"none"}} to="/signup"><span className="p-2 navLinks">signup</span></Link>
                            <Link style={{textDecoration:"none"}} to="/login"><span className="p-2 navLinks">login</span></Link>
                        </div>
                    </nav>
                    <span>
